...
require.register("@glidejs/glide/dist/glide.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "@glidejs/glide");
  (function() {
    /*!
 * Glide.js v3.3.0
...
require.register("functions/components/slider.js", function(exports, require, module) {
'use strict';
...
var Slider = function () {
  ...
  _createClass(Slider, [{
    ...
    value: function initSlider() {
      var sliderHero = new _glide2.default('#slider__hero', {
        type: 'carousel',
        startAt: 0,
        perView: 1,
        autoplay: 5000,
      ...
      sliderHero.on('move', function (event) {
...
require.register("functions/initialize.js", function(exports, require, module) {
'use strict';
...
var _hamburger = require('./layout/hamburger');
...
;require.register("functions/layout/hamburger.js", function(exports, require, module) {
'use strict';
  ...
  _createClass(Menu, [{
    ...
    value: function initMenu() {
      ...
      var resizeHeader = function resizeHeader() {
        var scrollPos = typeof window.scrollY === 'undefined' ? window.pageYOffset : window.scrollY;
        var originalSize = window.innerWidth > 768 ? 145 : 85;
        var sizeLogo = window.innerWidth > 768 ? 178 : 120;
        var topLogo = window.innerWidth > 768 ? 30 : 0;
      ...
      var checkUserIE = function checkUserIE() {
        var ua = window.navigator.userAgent;
        var msie = ua.indexOf('MSIE ');

        if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
          document.getElementsByClassName('benefits--btn')[0].addEventListener('click', function () {
            window.scrollTo(0, document.getElementsByClassName('benefits')[0].offsetTop - window.difference);
          });

          document.getElementsByClassName('style--btn')[0].addEventListener('click', function () {
      ...
      document.onscroll = function (event) {
        ...
        scrollTop > 175 ? _this.scrollBtn.style.display = 'block' : _this.scrollBtn.style.display = 'none';
        resizeHeader();
      };
...
var Register = function () {
  ...
  _createClass(Register, [{
    ...
    value: function initRegister() {
      ...
      var notAdult = 'Lo sentimos, debes ser mayor de edad';
      var invalidDate = 'Debes ingresar una fecha  válida';
      ...
      selectCity.onchange = function (event) {
      ...
      // Date
      var checkAdult = function checkAdult(birthday) {
        var today = (0, _moment2.default)();
        age = today.diff(birthDay, 'years');
        isAdult = age >= 18;
      };

      var changeFocus = function changeFocus(elem) {
        document.getElementById(elem).focus();
      };

      var checkLength = function checkLength(event) {
        var lengthString = event.target.id === 'year' ? 4 : 2;
        if (event.target.value.length === lengthString) {
          event.target.id === 'day' ? changeFocus('month') : event.target.id === 'month' ? changeFocus('year') : document.getElementById('year').blur();
        }
      };

      var checkNumbers = function checkNumbers(event) {
        ...
        if (dateInput.dayInput && dateInput.monthInput && dateInput.yearInput) {
          for (var _i = 0; _i < inputs.length; _i++) {
            inputs[_i].style.border = '0 solid transparent';
          }
          _this.addAlert('');
          birthDay = (0, _moment2.default)(inputs[2].value + '-' + inputs[1].value + '-' + inputs[0].value);
          if (isNaN(birthDay)) {
            for (var _i2 = 0; _i2 < inputs.length; _i2++) {
              inputs[_i2].style.border = '1px solid #E0655F';
            }
            _this.addAlert(invalidDate);
            dateBoolean = false;
          } else {
            ...
            if (isAdult) {
              for (var _i3 = 0; _i3 < inputs.length; _i3++) {
                inputs[_i3].style.border = '0 solid transparent';
              }
              _this.addAlert('');
              dateBoolean = true;
            } else {
              for (var _i4 = 0; _i4 < inputs.length; _i4++) {
                inputs[_i4].style.border = '1px solid #E0655F';
              }
              _this.addAlert(notAdult);
              dateBoolean = false;
            }
          }
        }
      ...
      // Validation Name
      document.getElementById('input-name').onkeyup = function (event) {
        if (event.target.value.match(/^[a-z ñáéíóú A-Z ÑÁÉÍÓÚ]+$/)) {
          ...
          nameBoolean = false;
          _this.addAlert('El campo Nombre sólo debe contener letras');
        }
        checkSubmit();
      };

      // Validation email
      document.getElementById('input-mail').onblur = function (event) {
        if (event.target.value.match(/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,5}))$/)) {
          ...
          emailBoolean = false;
          _this.addAlert('Ingresa una dirección de correo electrónico válida');
        }
      };
      // Validation phone
      document.getElementById('input-phone').onkeyup = function (event) {
        if (event.target.value.length > 1) {
          if (event.target.value.match('^([0-9][0-9]*)$')) {
            ...
            phoneBoolean = false;
            _this.addAlert('El campo Teléfono solo debe contener números');
          }
        }
        checkSubmit();
      };

      document.getElementById('input-phone').onblur = function (event) {
...
require.alias("@glidejs/glide/dist/glide.js", "@glidejs/glide");
