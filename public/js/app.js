...
var DatePicker = function () {
  ...
  _createClass(DatePicker, [{
    ...
    value: function initDatePicker() {
      ...
      var dp = (0, _tinyDatePicker2.default)('#input-date').on({
        open: function open() {
        ...
        select: function select(_, dp) {
          return console.log('A date was picked: ', dp.state.selectedDate);
        },
        statechange: function statechange(_, dp) {
          return console.log('The view, hilightedDate, and/or selectedDate changed: ', dp.state);
        }
