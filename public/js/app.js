    ...
    value: function initRegister() {
      ...
      dp.on({
        ...
        select: function select(_, dp) {
          ...
          birthDay = (0, _moment2.default)(dp.state.selectedDate);
          checkAdult(birthDay);
        },
      ...
      document.getElementById('input-city').onkeyup = function (event) {
        ...
        if (event.target.value.match(/^[a-z ñáéíóú A-Z ÑÁÉÍÓÚ]+$/)) {
          ...
          cityBoolean = false;
          _this.addAlert('El campo Ciudad sólo debe contener letras');
        }
        checkSubmit();
      };
