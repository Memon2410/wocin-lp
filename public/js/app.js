...
require.register("tiny-date-picker/dist/tiny-date-picker.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "tiny-date-picker");
  (function() {
    (function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
  typeof define === 'function' && define.amd ? define(factory) :
...
require.register("functions/components/datePicker.js", function(exports, require, module) {
"use strict";
...
var _tinyDatePicker = require('tiny-date-picker');
...
var Register = function () {
  ...
  _createClass(Register, [{
    ...
    value: function initRegister() {
      ...
      var dp = (0, _tinyDatePicker2.default)('#input-date', {
        lang: {
      ...
      dp.on({
        ...
        close: function close() {
          if (isAdult) {
            ...
            dateBoolean = false;
            _this.addAlert('Debes se mayor de edad');
          }
          if (parseInt(day) < 10) {
            day = '0' + day;
          }
        ...
        select: function select(_, dp) {
          ...
          birthDay = (0, _moment2.default)(year + '-' + month + '-' + day);
          checkAdult(birthDay);
        },

        statechange: function statechange(_, dp) {
...
require.alias("tiny-date-picker/dist/tiny-date-picker.js", "tiny-date-picker");require.register("___globals___", function(exports, require, module) {
